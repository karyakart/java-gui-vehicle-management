...
public class UI {
    ...
    private void createUI() {
        ...
        viewButton.setBackground(new Color(173, 216, 230));// sets color to all the buttons

        buttonPanel.add(addButton);
        buttonPanel.add(removeButton);
        buttonPanel.add(viewButton);
        panel.add(buttonPanel, BorderLayout.SOUTH);//sets button to the bottom of the UI
        ...
        });// code to add new vehicles for parking
        ...
        });// code to view all the parked vehicles
